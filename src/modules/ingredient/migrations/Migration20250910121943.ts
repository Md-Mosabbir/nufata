...
export class Migration20250910121943 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`create table if not exists "ingredient" ("id" text not null, "name" text not null, "removable" boolean not null default false, "product_id" text not null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "ingredient_pkey" primary key ("id"));`);
